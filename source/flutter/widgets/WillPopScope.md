...
WillPopScope用于处理**是否离开当前页面，在Flutter中有多种方式可以离开当前页面，比如AppBar、CupertinoNavigationBar上面的返回按钮，点击将会回到前一个页面，在Android手机上点击实体（虚拟）返回按钮，也将会回到前一个页面，此功能对于iOS程序员来说可能特别容易忽略。
...
![](http://img.laomengit.com/WillPopScope_1.gif)
...
![](http://img.laomengit.com/WillPopScope_2.gif)
...
![](http://img.laomengit.com/WillPopScope_3.gif)
